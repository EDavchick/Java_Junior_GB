...
public class Program {
     ...
     *
     * Фреймворк должен позволять аннотировать классы и поля для связывания
     * их с таблицами и столбцами в базе данных.
     *
     ...
     *      Реализуйте клас QueryBuilder, который может принимать объект и
     *      генерировать SQL-запросы для выполнения операций CRUD (Create,
     *      Read, Update, Delete) на основе аннотаций. Используйте Reflection
     *      для получения метаданных класса, аннотированного объекта, чтобы
     *      построить соответствующий SQL-запрос.
